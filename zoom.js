...
function show(products) {
    for(let i = 0; i < products.length; i++) {
        ...
        elem.innerHTML = "<div id='contain'><span class='product'><img src='" + products[i].Image + "'><span class='description'><h3>" + products[i].Name + "</h3>" + products[i].Genre + "<p>" + products[i].Price + "</p>" + "<p>" + products[i].Description + "</p><a href='dorejepov.github.io/zipped/signUp.html' type='button' class='shisui'>Buy</button></span></span></div>";
